...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2021 at 04:42 PM
...
--
ALTER TABLE `cart`
  MODIFY `cart_sno` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `subcategories`
  MODIFY `sub_cat_sno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `wishlist`
  MODIFY `wishlist_sno` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
